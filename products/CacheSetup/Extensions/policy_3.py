...
# default-cache-policy-v2
# A slightly improved version of the old default policy

POLICY_ID = "default-cache-policy-v2"
POLICY_TITLE = "Default Cache Policy, slightly improved"
