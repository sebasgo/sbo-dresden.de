...
# squid-without-vary
# Squid 2.6 without Vary header or compression

POLICY_ID = "squid-without-vary"
POLICY_TITLE = "Squid without Vary header (Note: Turn off compression)"
...
def addCacheRules(rules):
    ...
    if id not in rules.objectIds():
        ...
        rule.setLastModifiedExpression('python:rule.lastDate(rule.lastDate(), rule.getLastTransactionDate())')
        rule.setHeaderSetIdAnon('cache-with-last-modified')
